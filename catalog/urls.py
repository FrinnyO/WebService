...
from .views import (CategoryDetailView, ContactsView, HomeListView, ProductCreateView, ProductDeleteView,
                    ProductDetailView, ProductUpdateView, UnpublishedProductsListView, UnpublishProductView)
